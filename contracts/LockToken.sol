...
contract LockToken is Ownable, TokenTransfer {
    ...
    function lockTokens(
        ...
        safeTransferIn(_tokenAddress, _amount);

        //update balance in address
        walletTokenBalance[_tokenAddress][_beneficiary] = walletTokenBalance[_tokenAddress][_beneficiary]
            .add(_amount);

        address _withdrawalAddress = _beneficiary;
        _id = ++depositId;
    ...
    function withdrawTokens(uint256 _id) public {
        ...
        //update balance in address
        walletTokenBalance[lockedToken[_id].tokenAddress][msg
            .sender] = walletTokenBalance[lockedToken[_id].tokenAddress][msg
            .sender]
        ...
        for (
            ...
            if (
                depositsByWithdrawalAddress[lockedToken[_id]
                    .withdrawalAddress][j] == _id
            ) {
                for (
                    i = j;
                    i <
                    ...
                    depositsByWithdrawalAddress[lockedToken[_id]
                        .withdrawalAddress][i] = depositsByWithdrawalAddress[lockedToken[_id]
                        .withdrawalAddress][i + 1];
                }
                depositsByWithdrawalAddress[lockedToken[_id].withdrawalAddress]
                    .pop();
                break;
